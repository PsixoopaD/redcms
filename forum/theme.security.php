...
$doc = new document(2);
if(!$user->access('forum_theme_security'))$doc->access_denied(__('У Вас нет доступа!'));
...
$doc->title = __('Разрешение темы'); // шапка страницы
...
$form->display();
if ($user->access('forum_theme_act'))$doc->ret(__('Действия'), 'theme.actions.php?id=' . $theme['id']);
