...
if($user->access('forum_new_kat'))$doc->act(__('Создать категорию'), 'category.new.php');
if($user->access('forum_por_kat'))$doc->act(__('Порядок категорий'), 'categories.sort.php');
if($user->id)$doc->act(__('Статистика'), 'stat.php');