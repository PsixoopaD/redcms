...
class install_check_chmod {
    ...
    function check() {
        ...
        foreach ($nw as $path) {
            ...
            echo $path . ' ' . ($e ? '<span style="font-weight:bold; color: red;">[' . __('Проблема') . ']</span>' : '<span style="font-weight:bold; color: green;">[OK]</span>') . '<br />';
        ...
        if ($err) {
            ...
            echo '<span style="font-weight:bold; color: green;">' . __('Необходимые права на запись имеются') . '</span>';
