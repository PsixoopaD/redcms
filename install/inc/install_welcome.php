...
class install_welcome {
    ...
    function form(): bool
    {
        echo <<<HTML
            <div class="update">
            <a href="#"><img class="update_img" src="/install/1sl.jpg"></img></a>
            <a href="#"><img class="update_img" src="/install/2sl.jpg"></img></a>
            <a href="#"><img class="update_img" src="/install/3sl.jpg"></img></a>
            </div>
