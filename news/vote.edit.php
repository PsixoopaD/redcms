...
$doc = new document(2);
if(!$user->access('news_vote_edit')) $doc->access_denied(__('У Вас нет доступа!'));
...
$dcms->log('Новость','Закрытие голосования в новости [url=/news/comments.php?id=' . $news['id'] . ']' . $news['title'] . '[/url]');
...
$res->execute(Array($vote_a['id']));
$dcms->log('Новость','Обнуление голосования в новости [url=/news/comments.php?id=' . $news['id'] . ']' . $news['title'] . '[/url]');
...
$dcms->log('Новость','Удаление голосования в новости [url=/news/comments.php?id=' . $news['id'] . ']' . $news['title'] . '[/url]');
$doc->msg(__('Голосование успешно удалено'));
} else {
$dcms->log('Новость','Изменение параметров голосования в новости [url=/news/comments.php?id=' . $news['id'] . ']' . $news['title'] . '[/url]');
...
if (isset($_GET['return'])) $doc->ret('В новость', text::toValue($_GET['return']));
