...
$doc = new document(2);
if(!$user->access('news_vote_new')) $doc->access_denied(__('У Вас нет доступа!'));
...
$dcms->log('Новость','Создание голосования в новости [url=/news/comments.php?id=' . $news['id'] . ']' . $news['title'] . '[/url]');
